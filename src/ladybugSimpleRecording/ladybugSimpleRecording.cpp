...
#include "ladybugSimpleRecording.h"
...
{    
    ...
    //
	ladybugSetGrabTimeout(context, 100); //XXX 100 Sets the timeout (probably useful if GPS deactivated) interval ms

    //ladybugSetGrabTimeout( context, 0 ); //XXX old setting
